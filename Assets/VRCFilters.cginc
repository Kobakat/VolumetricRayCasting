...
fixed4 Highlight(float light, float3 col, int step, int mode, int gradient, float nonHighlightColorStrength, float3 emissiveCol) 
{
    ...
    {        
        ...
        //Singular Color
        case 1:
            highlight = fixed4(emissiveCol * light, 1);         
    }
